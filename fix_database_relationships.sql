...
-- Now let's add some dummy users for testing
-- First, we need to insert them into auth.users (this might need to be done differently in your setup)
-- For now, let's create profiles with fake UUIDs that we can use for testing
